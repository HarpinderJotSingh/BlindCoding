...
function runCode() {
  ...
  if (triesleft[qNumber] > 0) {
    ...
    triesleft[qNumber]--;
    triesleft[qNumber] == 1
      ? alert("You have 1 try left for this question.")
      : alert(
          "You have " + triesleft[qNumber] + " tries left for this question."
        );
  } else {
    alert("You have used up 3 tries.");
  }
}
      ...
      if (url == "runCode/") {
        ...
        if (getOutput() == "Correct Answer") {
          ...
          document
            ...
            .getElementsByTagName("h5")[0] = "Question " + qNo;
          document.getElementsByClassName("left")[0].innerHTML = getQuestion(
            qNo
          );
          console.log("OO");
        }
...
window.onresize = function() {
  if (window.outerHeight - window.innerHeight > 100) {
    ...
    alert(
      "Sorry! You will be logged out since you didn't follow the instructions."
    );
